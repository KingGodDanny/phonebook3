...
public class PhoneController {
	...
	//http://localhost:8088/phonebook3/write?name=정우성&hp=010-0000-0000&company=02-1234-1234
...
//	}
	...
	public String read(@PathVariable("no") int boardNo) {
		...
		//localhost:8088/phonebook3/board/read/1       read다음에 /숫자들이 위에 {no} ,no ,boardNo에 담긴다.
